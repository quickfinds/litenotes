...
class NoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // or you can use direct this method for crateting new record and save 
        /*   Note::create([
            'user_id' => Auth::id(),
            'title' => $request->title,
            'text' => $request->text
    ...
    public function show(Note $note)
    {
        ...
        // $note = Note::where('uuid', $note->uuid)->where('user_id', Auth::id())->firstOrFail();
    ...
    public function destroy(Note $note)
    {
        ...
        $note->delete();
        return to_route('notes.index')->with('success', 'Note move to trash successfully.');
